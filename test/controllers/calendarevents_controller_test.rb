...
class CalendareventsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calendarevent" do
    assert_difference('Calendarevent.count') do
      post calendarevents_url, params: { calendarevent: { description: @calendarevent.description, end_time: @calendarevent.end_time, name: @calendarevent.name, start_time: @calendarevent.start_time } }
    end
  ...
  test "should update calendarevent" do
    patch calendarevent_url(@calendarevent), params: { calendarevent: { description: @calendarevent.description, end_time: @calendarevent.end_time, name: @calendarevent.name, start_time: @calendarevent.start_time } }
