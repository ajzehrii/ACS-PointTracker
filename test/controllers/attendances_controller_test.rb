...
class AttendancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendance" do
    assert_difference('Attendance.count') do
      post attendances_url, params: { attendance: { meeting_ID: @attendance.meeting_ID, student_ID: @attendance.student_ID } }
    end
  ...
  test "should update attendance" do
    patch attendance_url(@attendance), params: { attendance: { meeting_ID: @attendance.meeting_ID, student_ID: @attendance.student_ID } }
