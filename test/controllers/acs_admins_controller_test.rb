...
class AcsAdminsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create acs_admin" do
    assert_difference('AcsAdmin.count') do
      post acs_admins_url, params: { acs_admin: { admin_ID: @acs_admin.admin_ID, password: @acs_admin.password, position: @acs_admin.position, student_ID: @acs_admin.student_ID, username: @acs_admin.username } }
    end
  ...
  test "should update acs_admin" do
    patch acs_admin_url(@acs_admin), params: { acs_admin: { admin_ID: @acs_admin.admin_ID, password: @acs_admin.password, position: @acs_admin.position, student_ID: @acs_admin.student_ID, username: @acs_admin.username } }
