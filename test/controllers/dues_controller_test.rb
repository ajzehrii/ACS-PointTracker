...
class DuesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create due" do
    assert_difference('Due.count') do
      post dues_url, params: { due: { ammount: @due.ammount, paid: @due.paid, semester_ID: @due.semester_ID, student_ID: @due.student_ID } }
    end
  ...
  test "should update due" do
    patch due_url(@due), params: { due: { ammount: @due.ammount, paid: @due.paid, semester_ID: @due.semester_ID, student_ID: @due.student_ID } }
